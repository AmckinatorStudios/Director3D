...
// Цвет блока по ключу (id камеры, номер дорожки). Одинаковый ключ всегда даёт
// одинаковый цвет — на монтаже это важнее красоты: два плана одной камерой
// должны читаться как одна камера, а не как два разных.
