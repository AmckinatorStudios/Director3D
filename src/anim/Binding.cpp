...
const std::vector<PropertyInfo> kTable = {
    {Property::Position,            "position",       "Положение",        3, {"X", "Y", "Z"}, {kAxisX, kAxisY, kAxisZ}, false},
    {Property::Rotation,            "rotation",       "Поворот",        3, {"X", "Y", "Z"}, {kAxisX, kAxisY, kAxisZ}, false},
    {Property::Scale,               "scale",          "Масштаб",           3, {"X", "Y", "Z"}, {kAxisX, kAxisY, kAxisZ}, false},
    {Property::Color,               "color",          "Цвет",           3, {"R", "G", "B"}, {kChanR, kChanG, kChanB}, false},
    {Property::LightColor,          "lightColor",     "Цвет света",     3, {"R", "G", "B"}, {kChanR, kChanG, kChanB}, false},
    {Property::LightIntensity,      "lightIntensity", "Яркость света", 1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::LightRange,          "lightRange",     "Дальность света",     1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::CameraFov,           "cameraFov",      "Угол обзора",             1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::CameraFocusDistance, "focusDistance",  "Дистанция фокуса",  1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::CameraAperture,      "aperture",       "Диафрагма",        1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::PostBloom,           "postBloom",      "Свечение",           1, {"", "", ""},    {kScalar, 0, 0},          false},
    {Property::PostVignette,        "postVignette",   "Виньетка",        1, {"", "", ""},    {kScalar, 0, 0},          false},
    ...
    {Property::MorphWeight,         "morphWeight",    "Форма смешивания",     1, {"", "", ""},    {kScalar, 0, 0},          false},
};
